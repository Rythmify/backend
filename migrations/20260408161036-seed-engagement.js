...
exports.up = async function (db) {
  ...
  await db.runSql(`
    ...
    ('a0000016-0000-0000-0000-000000000000',
    ...
    -- Reply to a0000016
    ('a0000017-0000-0000-0000-000000000000',
    ...
    ('a0000018-0000-0000-0000-000000000000',
  ...
  await db.runSql(`
    ...
    -- a0000001 (Midnight Run - Sara's comment)
    (gen_random_uuid(),'00000009-0000-0000-0000-000000000000','a0000001-0000-0000-0000-000000000000', NOW()-INTERVAL '129 days'),
    (gen_random_uuid(),'00000011-0000-0000-0000-000000000000','a0000001-0000-0000-0000-000000000000', NOW()-INTERVAL '128 days'),
    (gen_random_uuid(),'00000013-0000-0000-0000-000000000000','a0000001-0000-0000-0000-000000000000', NOW()-INTERVAL '127 days'),
    (gen_random_uuid(),'00000002-0000-0000-0000-000000000000','a0000001-0000-0000-0000-000000000000', NOW()-INTERVAL '126 days'),

    -- a0000002 (Midnight Run - Mo's comment)
    (gen_random_uuid(),'00000008-0000-0000-0000-000000000000','a0000002-0000-0000-0000-000000000000', NOW()-INTERVAL '127 days'),
    (gen_random_uuid(),'00000012-0000-0000-0000-000000000000','a0000002-0000-0000-0000-000000000000', NOW()-INTERVAL '126 days'),

    -- a0000005 (Karim's reply)
    (gen_random_uuid(),'00000008-0000-0000-0000-000000000000','a0000005-0000-0000-0000-000000000000', NOW()-INTERVAL '127 days'),
    (gen_random_uuid(),'00000009-0000-0000-0000-000000000000','a0000005-0000-0000-0000-000000000000', NOW()-INTERVAL '126 days'),
    (gen_random_uuid(),'00000010-0000-0000-0000-000000000000','a0000005-0000-0000-0000-000000000000', NOW()-INTERVAL '125 days'),

    -- a0000006 (Street Code - Mo's comment)
    (gen_random_uuid(),'00000011-0000-0000-0000-000000000000','a0000006-0000-0000-0000-000000000000', NOW()-INTERVAL '222 days'),
    (gen_random_uuid(),'00000013-0000-0000-0000-000000000000','a0000006-0000-0000-0000-000000000000', NOW()-INTERVAL '220 days'),

    -- a0000010 (Echo Lane - Fatma's comment)
    (gen_random_uuid(),'00000012-0000-0000-0000-000000000000','a0000010-0000-0000-0000-000000000000', NOW()-INTERVAL '190 days'),
    (gen_random_uuid(),'00000014-0000-0000-0000-000000000000','a0000010-0000-0000-0000-000000000000', NOW()-INTERVAL '188 days'),
    (gen_random_uuid(),'00000003-0000-0000-0000-000000000000','a0000010-0000-0000-0000-000000000000', NOW()-INTERVAL '186 days'),

    -- a0000013 (Blue Hour - Fatma's comment)
    (gen_random_uuid(),'00000012-0000-0000-0000-000000000000','a0000013-0000-0000-0000-000000000000', NOW()-INTERVAL '278 days'),
    (gen_random_uuid(),'00000014-0000-0000-0000-000000000000','a0000013-0000-0000-0000-000000000000', NOW()-INTERVAL '275 days');
  `);
  ...
  // ----------------------------------------------------------
  await db.runSql(`
    UPDATE comments SET reply_count = 2 WHERE id = 'a0000001-0000-0000-0000-000000000000';
    UPDATE comments SET reply_count = 1 WHERE id = 'a0000007-0000-0000-0000-000000000000';
    UPDATE comments SET reply_count = 1 WHERE id = 'a0000011-0000-0000-0000-000000000000';
    UPDATE comments SET reply_count = 1 WHERE id = 'a0000016-0000-0000-0000-000000000000';
  `);
};

exports.down = async function (db) {
  await db.runSql(`DELETE FROM comment_likes   WHERE comment_id LIKE 'a00000%';`);
  await db.runSql(`DELETE FROM comments        WHERE id         LIKE 'a00000%';`);
