...
exports.up = async function (db) {
  ...
  await db.runSql(`
    ...
    -- comments
    (gen_random_uuid(),'00000008-0000-0000-0000-000000000000','comment','a0000001-0000-0000-0000-000000000000','comment','00000002-0000-0000-0000-000000000000', NOW()-INTERVAL '130 days'),
    (gen_random_uuid(),'00000009-0000-0000-0000-000000000000','comment','a0000006-0000-0000-0000-000000000000','comment','00000004-0000-0000-0000-000000000000', NOW()-INTERVAL '225 days'),
    (gen_random_uuid(),'00000010-0000-0000-0000-000000000000','comment','a0000010-0000-0000-0000-000000000000','comment','00000003-0000-0000-0000-000000000000', NOW()-INTERVAL '192 days');
  `);
