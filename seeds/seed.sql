...
-- 22. CONVERSATIONS
-- Note: user_a_id MUST be < user_b_id (enforced by DB constraint)
...
-- 23. MESSAGES
-- trg_conversation_last_message_at trigger updates last_message_at automatically
-- trg_messages_validate_sender ensures sender is a participant in the conversation

INSERT INTO messages (id, conversation_id, sender_id, content, is_read) VALUES

  -- Basel Mones <-> Ali Hassan
  ('f2000000-0000-0000-0000-000000000001',
   'e2000000-0000-0000-0000-000000000001',
   'c2000000-0000-0000-0000-000000000001',
   'Hey Basel, your recitation is absolutely beautiful. Keep it up!', true),

  ('f2000000-0000-0000-0000-000000000002',
   'e2000000-0000-0000-0000-000000000001',
   'c1000000-0000-0000-0000-000000000001',
   'Thank you so much Ali, that really means a lot to me!', true),

  ('f2000000-0000-0000-0000-000000000003',
   'e2000000-0000-0000-0000-000000000001',
   'c2000000-0000-0000-0000-000000000001',
   'When are you dropping a new recitation?', false),

  -- Maryam <-> Sara Mostafa
  ('f2000000-0000-0000-0000-000000000004',
   'e2000000-0000-0000-0000-000000000002',
   'c2000000-0000-0000-0000-000000000002',
   'The episode about work-life balance really spoke to me!', true),

  ('f2000000-0000-0000-0000-000000000005',
   'e2000000-0000-0000-0000-000000000002',
   'c1000000-0000-0000-0000-000000000003',
   'So glad it helped Sara! More episodes coming soon.', true),

  -- Layla Mindset <-> Jake Williams
  ('f2000000-0000-0000-0000-000000000006',
   'e2000000-0000-0000-0000-000000000003',
   'c2000000-0000-0000-0000-000000000003',
   'Hey Layla, the morning habit episode completely changed my routine!', true),

  ('f2000000-0000-0000-0000-000000000007',
   'e2000000-0000-0000-0000-000000000003',
   'c1000000-0000-0000-0000-000000000005',
   'That means everything to me, thank you Jake!', false),

  -- Coach Karim <-> Omar Al-Farsi
  ('f2000000-0000-0000-0000-000000000008',
   'e2000000-0000-0000-0000-000000000005',
   'c2000000-0000-0000-0000-000000000005',
   'Coach, any advice for someone just starting to train during Ramadan?', true),

  ('f2000000-0000-0000-0000-000000000009',
   'e2000000-0000-0000-0000-000000000005',
   'c1000000-0000-0000-0000-000000000006',
   'Check out my Ramadan training episode, it covers everything you need!', false),

  -- Tariq Talks <-> Nour Khalil
  ('f2000000-0000-0000-0000-000000000010',
   'e2000000-0000-0000-0000-000000000006',
   'c2000000-0000-0000-0000-000000000006',
   'The Gen Z burnout episode was painfully accurate, felt seen!', true),

  ('f2000000-0000-0000-0000-000000000011',
   'e2000000-0000-0000-0000-000000000006',
   'c1000000-0000-0000-0000-000000000008',
   'Glad it resonated! Are you doing okay though?', true),

  ('f2000000-0000-0000-0000-000000000012',
   'e2000000-0000-0000-0000-000000000006',
   'c2000000-0000-0000-0000-000000000006',
   'Getting there slowly! Honestly your content helps a lot.', false);


-- 24. BLOCKS

INSERT INTO blocks (blocker_id, blocked_id) VALUES
  ('c2000000-0000-0000-0000-000000000003', 'c2000000-0000-0000-0000-000000000005'),
  ('c1000000-0000-0000-0000-000000000007', 'c2000000-0000-0000-0000-000000000006');


-- 25. NOTIFICATION PREFERENCES
-- One row per user, all columns use the migration defaults
