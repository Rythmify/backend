...
exports.getGenreTracks = async (req, res) => {
  ...
  const { pagination, ...data } = await discoveryService.getGenreTracks({
    genreId: genre_id,
    limit,
    offset,
    sort,
...
exports.getGenreAlbums = async (req, res) => {
  ...
  const { pagination, ...data } = await discoveryService.getGenreAlbums({
    genreId: genre_id,
    limit,
    offset,
  });
...
exports.getGenrePlaylists = async (req, res) => {
  ...
  const { pagination, ...data } = await discoveryService.getGenrePlaylists({
    genreId: genre_id,
    limit,
    offset,
  });
